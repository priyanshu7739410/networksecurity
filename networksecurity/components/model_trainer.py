...
class ModelTrainer:
    ...
    def track_mlflow(self,best_model,classificationmetric):
        try:
            ...
            logging.warning(f"MLflow tracking failed (e.g. DagsHub limits reached): {e}")
            print(f"MLflow tracking failed: {e}. Continuing training execution...")
...
if __name__ == '__main__':
    try:
        ...
        print("Model Training Completed. Artifact details:")
